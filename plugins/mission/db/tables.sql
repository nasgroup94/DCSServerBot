<<<<<<< HEAD
CREATE TABLE IF NOT EXISTS players (ucid TEXT PRIMARY KEY, discord_id BIGINT NOT NULL DEFAULT -1, name TEXT, manual BOOLEAN NOT NULL DEFAULT FALSE, first_seen TIMESTAMP DEFAULT (NOW() AT TIME ZONE 'utc'), last_seen TIMESTAMP, vip BOOLEAN NOT NULL DEFAULT FALSE);
=======
CREATE TABLE IF NOT EXISTS players (ucid TEXT PRIMARY KEY, discord_id BIGINT NOT NULL DEFAULT -1, name TEXT, manual BOOLEAN NOT NULL DEFAULT FALSE, first_seen TIMESTAMP NOT NULL DEFAULT (NOW() AT TIME ZONE 'utc'), last_seen TIMESTAMP, vip BOOLEAN NOT NULL DEFAULT FALSE);
